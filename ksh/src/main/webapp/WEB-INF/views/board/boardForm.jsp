		...
		<div class="container" role="main">
			...
			<form:form name="form" id="form" role="form" modelAttribute="boardVO" method="post" action="${pageContext.request.contextPath}/board/saveBoard">
				...
				<div class="mb-3">
					...
					<form:input path="cate_cd" type="text" class="form-control" id="cate_cd" placeholder="카테고리를 입력 해주세요" />
				</div>
				<div class="mb-3">
					<label for="title">제목</label>
					<form:input path="title" type="text" class="form-control" id="title" placeholder="제목을 입력 해주세요" />
				</div>
				...
				<div class="mb-3">
					...
					<form:input path="tag" type="text" class="form-control" id="tag" placeholder="태그를 입력해 주세요" />
				</div>
			</form:form>
			<div>
